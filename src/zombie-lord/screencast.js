...
class Screencast {
  ...
  async captureFrame(quality = 80) {
    ...
    try {
      // Add timeout so screenshot doesn't hang the loop for 10 seconds while the page is initially loading
      return await launcher.page.screenshot({ type: 'jpeg', quality, timeout: 500, caret: 'initial' });
    } catch (e) {
      return null;
    }
  }
